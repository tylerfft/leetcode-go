...
func RunClassWithExamples(t *testing.T, constructor interface{}, rawExamples [][3]string, targetCaseNum int) (err error) {
...
outer:
	...
	if targetCaseNum > 0 && allCasesOk {
		...
		return RunClassWithExamples(t, constructor, rawExamples, 0)
	}
...
func RunClassWithFile(t *testing.T, constructor interface{}, filePath string, targetCaseNum int) error {
	...
	return RunClassWithExamples(t, constructor, examples, targetCaseNum)
}
